#
#  Be sure to run `pod spec lint EXFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "翾燚" => "email@address.com" }
  # Or just: s.author    = "翾燚"
  # s.authors            = { "翾燚" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/翾燚"
  ...
  s.source_files  = "EXFramework", "EXFramework/EXFramework/*.{h,m}"
